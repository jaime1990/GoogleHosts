 ...
 */
public class HostsDetailActivity extends AppCompatActivity {
	private static final String TAG = "HostsDetailActivity";
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		AsyncTask.execute(new Runnable() {
			@Override
			public void run() {
				File host = new File(MyConstants.SYSTEM_HOST_FILE_PATH_NORMAL);
